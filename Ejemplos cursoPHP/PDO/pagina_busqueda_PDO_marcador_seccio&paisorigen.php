...
<body>
    <?php
        ...
        $busqueda_porig=$_GET["paisdeorigen"];
    ...
    //try...catch...finally, Intenta esto...y si se produce un error capturalo(catch) y finalmente haz esto (finally). El finally siempre se ejecuta independientemente de que haya hecho el try o el catch
        try{
            ...
            $sql="SELECT CODIGOARTICULO, SECCION, NOMBREARTICULO, PRECIO, FECHA, IMPORTADO, PAISDEORIGEN FROM productos where SECCION= :m_sec AND PAISDEORIGEN= :m_porig"; //UTILIZO MARCADOR
